...
def main():
    ...
    if args.dataset == 'oxiod':
        # [yhat_delta_p, yhat_delta_q] = model.predict([x_gyro[0:600, :, :], x_acc[0:600, :, :]], batch_size=1, verbose=1)
        #resnet 9D
    ...
    plt.show()
    plt.savefig("Trajectory_{}_{}_{}.png".format(args.model, args.dataset, time()))
